...
public class DocumentScannerFragment extends AbstractScannerFragment {

    public static DocumentScannerFragment newInstance(String aTitle) {
        DocumentScannerFragment cameraFragment = new DocumentScannerFragment();
